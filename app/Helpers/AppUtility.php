...
class AppUtility {
    ...
    public static function sendEmail( $subject = null, $body = null, $to_email = null,$hash,$fileName=null, $ccEmail=null)
    {

        $senderModelObj = new SenderModel();
        $senderDetails = $senderModelObj->viewSenderDetails();
        ...
        if(empty($fileName))
        {
                ...
                'bcc' => [
                    [
                        'address' => [
                            ...
                            'email' => 'recruitmentappbcc@tudip.com',
                        ],
                    ],
                ],
            ...
            foreach($ccEmail as $list){
                $ccEmailArray[] = array('address'=>array('email'=>$list));
            }
            //print_r($asss);die;
            $basePath = public_path('letter/');
            $filename = $fileName;
